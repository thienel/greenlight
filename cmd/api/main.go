...
func main() {
	...
	flag.StringVar(&cfg.env, "env", "development", "Environment (development|staging|producttion)")
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "0a33cf29b0bc6d", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "957bd121724c73", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <lethien.dev@gmail.com>",
		"SMTP sender")
